/**
 * 彩票选号器 双授权协议 v1.0 全文（中英双语）
 * 与根目录 LICENSE 文件保持一致，用于应用内协议弹窗展示。
 */
export const LICENSE_TITLE_ZH = '彩票选号器 双授权协议 v1.0'
export const LICENSE_TITLE_EN = 'Lottery Picker Dual License v1.0'
export const CONTACT_EMAIL = 'new_mr_awei@163.com'

export const LICENSE_TEXT = `彩票选号器 双授权协议 v1.0
Lottery Picker Dual License v1.0
版权所有 © 2026 彩票选号器（new_mr_awei@163.com）
Copyright © 2026 Lottery Picker (new_mr_awei@163.com)
================================================================================
中文版本
================================================================================
