...
export const CHANGELOG = [
  {
    ...
    title: '双授权协议上线 · 开源合规',
    items: [
      '项目正式采用「彩票选号器 双授权协议 v1.0」，根目录新增 LICENSE 文件（中英双语全文）',
      '非商业使用免费（个人 / 非盈利组织 / 教育机构），商业使用需联系作者购买授权',
      '恶意程序禁止条款三层保护：防篡改注入、防植入恶意程序、防用于恶意程序（免费版与商业版均必须遵守）',
      '设置页「关于软件」新增开源协议入口，点击弹窗展示完整中英双语协议全文，底部联系邮箱支持一键复制',
      'README 重写为中英双语版本，明确协议声明与应用内查看路径',
